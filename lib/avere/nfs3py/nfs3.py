...
class nfs_fh3(vararray_limited):
    '''
    This may be used with both Avere and non-Avere filehandles, so the default __str__())
    does not decode it as an Avere filehandle. In the future, we may want to add
