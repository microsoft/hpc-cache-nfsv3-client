...
#
'''
setuptools script to generate an installable module for hpc-cache-nfs3py
'''
...
LIBFILES = (os.path.join('nfs3py', 'nfs3.py'),
            os.path.join('nfs3py', 'nfs3_util.py'),
            os.path.join('nfs3py', 'rpc_rfc1057.py'),
           )
